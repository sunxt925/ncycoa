...
<body>
	<h:datagrid actionUrl="repair_management.htm?dgdata" fit="true" fitColumns="true" queryMode="group" name="repairlist">
		...
		<h:dgConfOpt title="通过" url="repair_management.htm?audit&auditor=director&id={id}&res=yes" message="确认审核？" />
		<h:dgConfOpt title="不通过" url="repair_management.htm?audit&auditor=director&id={id}&res=no" message="确认审核？" />
	</h:datagrid>
</body>
