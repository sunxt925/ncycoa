  ...
  <tr>
    <td colspan="3" valign="top" class="main_table_centerbg" align="center"><table width="100%" border="1" cellspacing="0" cellpadding="0" class="table_list1">
      <tr>
        ...
        <td width="80%"><input name="DocCode" type="text" class="input1" id="DocCode" onKeyDown="EnterKeyDo('')" value="<%=mo.getDocCode()%>" size="30" maxlength="50"  readonly="readonly"></td>
      </tr>
      <tr>
       ...
       <tr> 
	  <td width="20%"><div align="right">版本状态：</div></td>
        <td width="80%">
        <select name="DocVersionStatus"  id="DocVersionStatus" style="width:192px">
             <option value="<%=mo.getDocVersionStatus()%>"SELECTED><%=mo.getDocVersionStatus()%></option>
             <option value="历史版本">历史版本</option>
             <option value="发布版本">发布版本</option>
             <option value="工作版本">工作版本</option>
          </select>
          </td>     
      </tr>
      <tr>
	  ...
	  <td width="20%"><div align="right">编制部门：</div></td>
        <td width="80%"><input name="DrawUpOrg" type="text" class="input1" id="DrawUpOrg" onKeyDown="EnterKeyDo('')" value="<%=mo.getDrawUpOrg()%>" size="30" maxlength="30"></td>      
      </tr>
            <tr> 
