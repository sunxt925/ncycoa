  ...
  <tr>
    <td colspan="3" valign="top" class="main_table_centerbg" align="center"><table width="100%" border="1" cellspacing="0" cellpadding="0" class="table_list1">
      <tr>
        ...
        <td width="80%">
         <%out.print(cu.print("COM_MEETINGINFO","AUDITOPINION",mo.getAuditOpinion())); %></tr>
    <tr>
        <td width="20%"><div align="right">审核：</div></td>
        <td width="80%">
        
          通过<input type="radio"  name="COM_MEETINGINFO.AUDITFLAG" id="COM_MEETINGINFO.AUDITFLAG" value="11" />
          不通过<input type="radio"  name="COM_MEETINGINFO.AUDITFLAG" id="COM_MEETINGINFO.AUDITFLAG" value="10" />

        </td>
      </tr>
      <tr>
      <td>
      <input type="hidden"  name="COM_MEETINGINFO.AUDITOR" id="COM_MEETINGINFO.AUDITOR" value="<%=name%>" />
      <input type="hidden"  name="COM_MEETINGINFO.AUDITORGCODE" id="COM_MEETINGINFO.AUDITORGCODE" value="<%=orgcode%>" />
      <input type="hidden"  name="COM_MEETINGINFO.AUDITDATE" id="COM_MEETINGINFO.AUDITDATE" value="<%=data%>" />
