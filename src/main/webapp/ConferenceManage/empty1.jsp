...
<%
	...
	DataTable dt=role.getAllMeetingList(page_no,per_page);
...
function F3()
{
	var url="ConferenceManage/meeting_new.jsp";
	createwindow('会议录入',url,'500px','500px');
...
var url="ConferenceManage/meeting_mod.jsp?bm="+rolecode;
createwindow('修改会议',url,'500px','500px');
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
          <td class="table_td_jb"><a href="#" onClick="F3()">增加[F3]</a><a href="#" onClick="F5()">刷新[F5]</a></td>
      </tr>
  </table>
  </td></tr>
	<tr>
