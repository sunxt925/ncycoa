...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
          <td class="table_td_jb"><!--<a href="#" onClick="F4()">删除[F4]</a>　--><a href="#" onClick="F5()">刷新[F5]</a></td>
      </tr>
  </table>
  </td></tr>
	<tr>
	...
	if (dt!=null && dt.getRowsCount()>=0) {
		...
		tu.setCheckBoxName("选择");
								...
								tu
										.setRowValue(
												"操作",
												"<a href=\"attend.jsp?bm=@MEETINGNO@\" class=\"button4\" target=\"memember\">参会人员</a><a href=\"#\" onclick=\"F1('@MEETINGNO@')\" class=\"button4\">修 改</a><a href=\"#\" onclick=\"F6('@MEETINGNO@')\" class=\"button4\">重新提交</a>");
								tu.setDisplayCol("meetingno,rn");
								//tu.setDisplayCol("会议编号,rn");
