...
<%
	...
	int per_page=20;
    DataTable dt=og.getMemberinfomList(page_no,per_page,bm);
...
<form name="form1" id="form1" method="post" action="../servlet/PageHandler">
  <tr>
	...
	%>
      <a href="#" onClick="F3()" >邮件通知  </a><a href="#" onClick="F3()" >   手机短信</a>
      <table width="100%" border="0" cellpadding="3" cellspacing="0">
        <tr><!--
         ...
         String unitccmtemp="&bm="+bm;
      	out.print(PageUtil.DividePage(page_no,pagecount,"attend1.jsp",unitccmtemp));
       %>
       </td>
