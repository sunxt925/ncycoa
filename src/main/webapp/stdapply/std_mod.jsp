<%@ page contentType="text/html; charset=gb2312" language="java" import="java.sql.*,com.db.*,com.common.*,com.entity.std.*,com.entity.system.*,com.entity.stdapply.*" errorPage="" %>
...
<%
	...
	String bm=Format.NullToBlank(request.getParameter("bm"));
  	DocReviseInifo mo=new DocReviseInifo(bm);
