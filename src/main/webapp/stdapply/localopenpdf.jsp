<%@ page language="java" import="java.util.*,java.io.*,com.ftp.*,com.entity.ftp.*,com.entity.stdapply.*" pageEncoding="gb2312"%>
...
<%
	...
	DocApplyStore applystore=new DocApplyStore(storefileno);
	String pdfname=applystore.getFileName();
	String urls=applystore.getStoreDirURL();
