...
String dataurl="meritjson_c.jsp?class=c&year="+year+"&month="+month;
%>
<body>
   <div style="width: 100%">
    ...
    <tr>
	    ...
	    <th data-options="field:'companycode',width:100">单位编码</th>
...
$("#btn_add").click(function(){
	 ...
	 if(row==null){
		 ...
		 createwindow("直接加减分","allmeritchangescore/changescore.jsp?flag=c&recno="+row.recno+"&objectcode="+row.companycode+"&year="+"<%=year%>"+"&month="+"<%=month%>",300,400);
	 }
	    });
