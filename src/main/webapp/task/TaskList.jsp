...
<%
	...
	//Log.Debug(per_page);
	DataTable dt=Task.getTaskList(page_no,per_page,u.getYybdm());
	int dtcount=Task.getTaskListCount(u.getYybdm());
	int pagecount=0;
...
<form name="form1" id="form1" method="post" action="../servlet/PageHandler">
  ...
  <tr>
   ...
   <%
		...
		tableutil.setDisplayCol("rn,工作序号,审核标识");
		
		//tableutil.setLineAction("onclick=\"getmember('@工作序号@','@审核标识@')\"");
