...
<%
	...
	//Log.Debug(per_page);
	DataTable dt=Task.getAllTaskListByQuery(page_no,per_page,date,orgcode);
	int dtcount=Task.getTaskListCountByDate(orgcode,date);
...
<form name="form1" id="form1" method="post" action="../servlet/PageHandler">
  ...
  <tr>
   ...
   <%
		...
		tableutil.setDisplayCol("rn,工作序号,选择");
	...
	%>
      ...
      <table width="100%" border="0" cellpadding="3" cellspacing="0">
        <tr>
          ...
          all.append("date=").append(date).append("&orgcode=").append(orgcode);
      	out.print(PageUtil.DividePage(page_no,pagecount,"TaskAllDate.jsp",all.toString()));
       %>
       </td>
