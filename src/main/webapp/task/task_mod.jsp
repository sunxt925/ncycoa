  ...
  <tr>
    <td colspan="3" valign="top" class="main_table_centerbg" align="center"><table width="100%" border="1" cellspacing="0" cellpadding="0" class="table_list1">
      <tr>
        ...
        <%out.print(cu.print("MONTHTASK","TASKNAME",task.getTaskname())); %>
        <!-- 
      ...
      <tr>
        ...
        <td>
         <%out.print(cu.print("MONTHTASK","TASKDESC",task.getTaskdesc())); 
         
         //System.out.println(cu.print("MONTHTASK","TASKDESC",task.getTaskdesc()));
         %>
         <!-- 
	  ...
	  <tr>
        ...
        <td>
        <%out.print(cu.print("MONTHTASK","MONTH",task.getMonth())); %>
        <!--
      ...
      <!--<tr>
        <td align="right">参与人数目：</td>
        <td>
        
         <%
         String num = "" + task.getNumparticipant();
         out.print(cu.print("MONTHTASK","NUMPARTICIPANT",num)); %>
	  ...
	  --><tr>
        ...
        <input name="gdls" type="text" class="input1" id="gdls" onKeyDown="EnterKeyDo('F8()')" onKeyUp="this.value=this.value.replace(/\D/g,'')" value="0" size="3" maxlength="3"  onafterpaste="this.value=this.value.replace(/\D/g,'')" style="text-align:right">
         ...
         -->
         <%out.print(cu.print("MONTHTASK","MEMO",task.getMemo())); %>
        </td>
      </tr>
         <input type="hidden" name="entity" id="entity" value="MONTHTASK"/>
          <input type="submit" name="Submit" value="提交" style="display:none">
            <input type="reset" name="reset" value="重置" style="display:none">
            <input type="hidden" name="MONTHTASK.TASKNO" id="MONTHTASK.TASKNO" value=<%=task.getTaskno() %>>
            <input type="hidden" name="old_TASKNO" id="old_TASKNO" value=<%=task.getTaskno() %>>
