...
AllMeritGroupMember allMeritGroupMember=new AllMeritGroupMember(groupno,staffcode);
%>
<body>
	<form name="form1" id="form1" method="post" action="../../servlet/PageHandler">
		...
		<table cellpadding="5"  width="100%" align="left" >
			...
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_ALLMERITGROUPMEMBER","GROUPNO",allMeritGroupMember.getGroupNo(),"readonly")); 
					%>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_ALLMERITGROUPMEMBER","OBJECTTYPE",allMeritGroupMember.getObjectType()));
					%>
				</td>
			</tr>
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_ALLMERITGROUPMEMBER","ORGCODE",allMeritGroupMember.getOrgCode()));
					%>
				</td>
			</tr>
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_ALLMERITGROUPMEMBER","POSITIONCODE",allMeritGroupMember.getPositionCode())); 
					%>
				</td>
			</tr>
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_ALLMERITGROUPMEMBER","STAFFCODE",allMeritGroupMember.getStaffCode()));
					%>
			...
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_ALLMERITGROUPMEMBER","MEMO",allMeritGroupMember.getMemo()));
					%>
				</td>
			</tr>
        ...
        <input name="old_GROUPNO" id="old_GROUPNO" type="hidden" value="<%=groupno%>"/>
         <input name="old_STAFFCODE" id="old_STAFFCODE" type="hidden" value="<%=staffcode%>"/>
