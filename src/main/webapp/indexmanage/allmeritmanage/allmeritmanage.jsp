...
int per_page = u.getPerpage_full()/4;
...
<div  id="top" data-options="region:'north',split:true" style="height:350px;">
...
<%
							if (dt != null && dt.getRowsCount() >= 0)
							{
								...
								tu.setRowValue(
										"操作",
										"<a  href=\"#\"  onclick=\"detail('@groupno@')\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-remove',plain:true\">关联成员</a>");
...
<div id="bottom2" data-options="region:'center'" style="padding:5px;border: 0px;">
    <iframe src="" name="allmeritgroupmember" style="border: 0px;width: 100%;height: 95%;"></iframe>
 </div>
   </form>
