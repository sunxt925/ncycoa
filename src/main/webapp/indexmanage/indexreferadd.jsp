...
<body>
	<form name="form1" id="form1" method="post" action="../servlet/PageHandler">
		...
		<table cellpadding="5"  width="100%" align="left" >
			...
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_REFEROBJECTINDEX","OBJECTCODE",objectcode,"readonly")); 
					%>
				</td>
			</tr>
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_REFEROBJECTINDEX","OBJECTTYPE",objecttype));
					%>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_REFEROBJECTINDEX","INDEXCODE",indexcode,"readonly"));
					%>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_REFEROBJECTINDEX","PARACODE",paracode,"readonly"));
					%>
				</td>
			</tr>
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_REFEROBJECTINDEX","REFOBJECTCODE")); 
					%>
			...
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_REFEROBJECTINDEX","REFOBJECTTYPE"));
					%>
				</td>
			</tr>
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_REFEROBJECTINDEX","REFINDEXCODE"));
					%>
			...
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_REFEROBJECTINDEX","REFMODE",refmode,"readonly"));
					%>
				</td>
			</tr>
			<tr>
				...
				<td>
					<%
					out.print(cu.print("TBM_REFEROBJECTINDEX","MEMO"));
					%>
				</td>
			</tr>
		</table>
		...
		<!-- 隐藏字段 -->
		<input name="TBM_REFEROBJECTINDEX.RECNO" id="TBM_REFEROBJECTINDEX.RECNO"  type="hidden" value="<%=IndexCode.getRecno("RU")%>">
		<input name="entity" id="entity" type="hidden" value="TBM_REFEROBJECTINDEX"/>
        <input name="act" type="hidden" id="act" value="add">
        <input type="submit" name="Submit" id="Submit" value="提交" style="display:none">
	...
	<script>
	    ...
	    $("#btn_selectobject").click(function(){
	    	var objtype="<%=indexclass%>";
	    	var u="";
	    	if(objtype=="S")
	    	    u="indexmanage/selectstaff.jsp";
	    	else
	    		u="indexmanage/selectunit.jsp";
	    ...
	    function returnobjValue(data){
	    	...
	    	var refobjectcode="";
	    	if(objtype=="S")
	    	refobjectcode=objectarray[0].staffcode;
	    	else
	    		refobjectcode=objectarray[0].orgcode;
