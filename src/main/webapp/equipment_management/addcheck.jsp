...
<form id="formobj" name="formobj" action="specialequipment_management.htm?save_check"  method="post">
...
<table style="width:600px;border-spacing:1px;" class="formtable">
  <tr>
		...
		<td class="value"><input class="inputxt" disabled="disabled" style="width:150px;" id="name" name="name"  value="${specialEquipment.name}">
		<span class="Validform_checktip"></span>
		</td>
	</tr>
	<tr>
		<td align="right"><label class="Validform_label">维保单位</label></td>
		<td class="value"><input class="inputxt" disabled="disabled" style="width:160px;" id="maintenDepart" name="maintenDepart" value="${specialEquipment.maintenDepart}">
		<span class="Validform_checktip"></span>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td align="right"><label class="Validform_label">当前检测时间</label></td>
		<td class="value"><input class="easyui-datebox" style="width:150px;" id="checkDate" name="checkDate" value="${specialEquipment.checkDate}">
		<span class="Validform_checktip"></span>
		</td>
	</tr>
	<tr>
		<td align="right"><label class="Validform_label">当前检测情况</label></td>
		<td class="value"><input class="inputxt" style="width:160px;" id="checkStatus" name="checkStatus" value="${specialEquipment.checkStatus}">
		<span class="Validform_checktip"></span>
		</td>
	</tr>
