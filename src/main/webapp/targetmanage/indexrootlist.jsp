...
<form name="form1" id="form1" method="post"action="../servlet/PageHandler">
	...
	<table  id="mytable"  class="rootlisttab" width="100%" style="" border="1" cellpadding="5" cellspacing="0" class="table_list">
					...
					<a  href="#"  onclick="del('${item.indexCode}')" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">删除</a>
						<c:choose>
							<c:when test="${item.isLast=='1'}">
								<a href="#" onclick="addversion('${item.indexCode}')"
									class="easyui-linkbutton"
									data-options="iconCls:'icon-add',plain:true">增加版本号</a>
							</c:when>
							<c:otherwise>
							</c:otherwise>
						</c:choose>
