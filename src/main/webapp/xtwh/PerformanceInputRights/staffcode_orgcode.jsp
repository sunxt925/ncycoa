...
<%
	response.setContentType("text/html;charset=GB18030"); 
     ...
     String list =""; 
    String sql="select orgcode,orgname from base_org where orgcode in(select orgcode from TBM_MeritInputTaskPerson where staffcode ='"+staffcode+"') order by orgcode ";
