...
function changetopunit(unitccm)
{
	...
	var newtreeurl='../../tree/unit_tree.jsp?pageurl=../xtwh/PerformanceInputRights/unit_list.jsp&pagetarget=unitlist&unitccm='+unitccm;
    ...
    <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<td valign="top" height="100%">
			<iframe src="unit_list.jsp" name="unitlist" id="unitlist" width="100%" height="100%" scrolling="auto" frameborder="0"></iframe>
