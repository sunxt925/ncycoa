   ...
   <div  id="top_div">
      ...
      <div id="bottom_div">
               ...
               <table width="100%" height="94%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                  <td width="20%"> 
                 <iframe src="orgpositionmanage_left.jsp" height="90%"></iframe>
                 </td>
                  <td width="80%" >
               <iframe src="unit_positionlist.jsp" name="unitpositionlist" id="unitpositionlist" height="45%"  width="95%"></iframe><br>
                 <iframe src="" name="temp" id="temp" height="45%"  width="95%" scrolling="no"></iframe> 
                 </td>
                   </tr>
            </table> 
      </div>
