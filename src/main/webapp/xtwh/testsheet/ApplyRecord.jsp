...
<tr>
    <td colspan="3" valign="top" class="main_table_centerbg" align="center"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr valign="top">
            <td valign="top"><iframe src="empty1.jsp" name="conferencelist" id="conferencelist" width="100%" height="100%" scrolling="no" frameborder="0"></iframe></td>
		  </tr>
		  <tr valign="bottom">
  ...
  <a href="#" onClick="F3()">保存</a>
  <tr>
  <input name="act" type="hidden" id="act" value="save">
        <input type="submit" name="Submit" value="提交" style="display:none">
          <input type="reset" name="reset" value="重置" style="display:none">
           <input type="hidden" id="entity" name="entity" value="PURCHASE">
         
           <input name="action_class" type="hidden" id="action_class" value="com.action.system.purchaseAction"></td>
