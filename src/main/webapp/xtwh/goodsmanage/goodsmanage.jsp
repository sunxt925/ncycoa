...
{
	var newlisturl='goods_list.jsp?unitccm='+unitccm;
	var newtreeurl='../../tree/goods_tree.jsp?pageurl=../xtwh/goodsmanage/goods_list.jsp&pagetarget=goodslist&unitccm='+unitccm;
	document.getElementById("goodslist").src=newlisturl;
    ...
    <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td valign="top" height="100%"><iframe src="../../tree/goods_tree.jsp?pageurl=../xtwh/goodsmanage/goods_list.jsp&pagetarget=goodslist" name="goodstree" id="goodstree" width="100%" height="100%" scrolling="auto" frameborder="0"></iframe></td>
          </tr>
        </table>
