    ...
    <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td valign="top" height="100%"><iframe src="goodsclasscheckbox_tree.jsp?pageurl=../xtwh/goodssearch/goodsStore_list.jsp&pagetarget=goodsStorelist" name="goodstree" id="goodstree" width="100%" height="100%" scrolling="auto" frameborder="0"></iframe></td>
          </tr>
        </table>
		
		</td>
		<td valign="top" height="100%">
			<iframe src="goodsStore_list.jsp" name="goodsStorelist" id="goodsStorelist" width="100%" height="100%" scrolling="no" frameborder="0"></iframe>
