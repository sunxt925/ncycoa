...
<%
	...
	DataTable dt=webFlowCode.getAllWebflowCodeColList(table_name,page_no,per_page);
	DataTable dtcount=webFlowCode.getAllWebFlowCodeList(table_name);
  ...
  <td colspan="3" valign="top" class="main_table_centerbg" align="center"><table width="100%" border="1" cellpadding="0" cellspacing="0" class="table_list">
   <%
	...
	%>
      ...
      <%
      	out.print(PageUtil.DividePage(page_no,pagecount,"code_list3.jsp","table_name="+table_name));
       %></td>
      </table><%}else{%>
