...
<%@page import="com.entity.system.FormCode"%>
...
<%
 ...
 String prmcod=request.getParameter("prmcod");
  FormCode formcode=new FormCode(prmcod);
 %>
  ...
  <tr>
    <td colspan="3" valign="top" class="main_table_centerbg" align="center"><table width="100%" border="1" cellspacing="0" cellpadding="0" class="table_list1">
      ...
      <tr>
        ...
        <td width="70%">
        <%out.print(cu.print("CODCTCTP","PRMCOD",formcode.getPrmcod(),"readonly")); 
      ...
      <tr>
        ...
        <td width="70%">
        <%out.print(cu.print("CODCTCTP","PRMCDD",formcode.getPrmcdd())); 
       ...
       <input name="entity" id="entity" type="hidden" value="CODCTCTP"/>
        ...
        <input type="hidden" name="old_PRMCOD" id="old_PRMCOD" value="<%=formcode.getPrmcod()%>"/>
