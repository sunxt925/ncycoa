...
<%@page import="com.entity.system.FormCodeItem"%>
...
String prmcod=request.getParameter("prmcod");
 ...
 FormCodeItem formCodeItem=new FormCodeItem(prmcod,prmcon);
  ...
  <tr>
    <td colspan="3" valign="top" class="main_table_centerbg" align="center"><table width="100%" border="1" cellspacing="0" cellpadding="0" class="table_list1">
      ...
      <tr>
        ...
        <td width="70%">
        <%out.print(cu.print("CODCTDEP","PRMCON",prmcon,"readonly")); 
        ...
        <td width="70%">
        <%out.print(cu.print("CODCTDEP","PRMCND",formCodeItem.getPrmcnd())); 
       ...
       <input name="entity" id="entity" type="hidden" value="CODCTDEP"/>
        <input name="act" type="hidden" id="act" value="modify">
          ...
          <input type="hidden" name="old_PRMCOD" id="old_PRMCOD" value="<%=prmcod%>"/>
           <input type="hidden" name="old_PRMCON" id="old_PRMCON" value="<%=prmcon%>"/>
