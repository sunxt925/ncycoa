...
function F3()
{
    ...
    parent.menutree.loaction.reload;
...
<form name="form1" id="form1" method="post" action="../../servlet/PageHandler">
  ...
  <tr>
    ...
    <td width="94%" height="5" class="main_table_bottombg"><input name="act" type="hidden" id="act" value="del"> <input name="ParentOrgCode" type="hidden" id="ParentOrgCode" value="<%=unitccm%>"> <input name="item" type="hidden" id="item" value=""><input name="action_class" type="hidden" id="action_class" value="com.action.system.SystemModuleAction"></td>
