...
<form name="form1" id="form1" method="post" action="../../servlet/PageHandler">
  <table cellpadding="5"  width="100%" align="left" >
        ...
        %>
			...
			<tr> 
	  <td><span>行政类别：</span></td>
        <td>
        <%
        	out.print(cu.print("BASE_ORG","ADMINCLASS",mo.getAdminClass()));
        %>   
       </tr>
			<tr>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table_list1">
      ...
      <tr>  
	   <td width="20%"><div align="right">备注：</div></td>
        ...
        <!--
        <input name="NonLeafFlag" type="hidden" class="input1" id="NonLeafFlag"  value="<%=mo.getNonLeafFlag ()%>">
        -->
