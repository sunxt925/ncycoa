...
<%
	...
	RolePosition og=new RolePosition();
	
	int page_no=Integer.parseInt(Format.NullToZero(request.getParameter("page_no")));
	int per_page=20;
	DataTable dt=og.getRolePositionList(page_no,per_page,bm);
...
function F3()
{
	...
	showModalDialogWin("systemrole_position_new.jsp?bm="+"<%=bm%>",1000,600);
      ...
      <table width="100%" border="0" cellpadding="3" cellspacing="0">
        <tr><!--
         ...
         String unitccmtemp="&bm="+bm;
      	out.print(PageUtil.DividePage(page_no,pagecount,"systemrole_position_manage.jsp",unitccmtemp));
       %>
       </td>
