...
<form name="form1" id="form1" method="post" action="../../servlet/PageHandler">
  <tr>
    ...
    <td width="94%" valign="middle" class="main_table_topbg" height="31">首页 &gt;&gt; 系统维护 &gt;&gt; <a href="systemrole_manage.jsp">角色管理</a> &gt;&gt; 角色修改</td>
  ...
  <tr>
    <td colspan="3" valign="top" class="main_table_centerbg" align="center"><table width="100%" border="1" cellspacing="0" cellpadding="0" class="table_list1">
      <tr>
        ...
        <!--<input name="Rolecode" type="text" class="input1" id="Rolecode" onKeyDown="EnterKeyDo('')" size="30" maxlength="30" value="<%=systemRole.getRolecode() %>"></td>-->
      </tr>
    <tr>
        <td width="20%"><div align="right">角色名称：</div></td>
        <td width="80%">
        <%out.print(cu.print("SYSTEM_ROLE","ROLENAME",systemRole.getRolename())); %>
        <!--<input name="Rolename" type="text" class="input1" id="Rolename" onKeyDown="EnterKeyDo('')" size="30" maxlength="30" value="<%=systemRole.getRolename() %>"></td>-->
      </tr>
      <tr>
        <td width="20%"><div align="right">角色模式：</div></td>
        <td width="80%">
        <%out.print(cu.print("SYSTEM_ROLE","ROLEMODE",systemRole.getRolemode()));%><!--
        <input name="Rolemode" type="text" class="input1" id="Rolemode" onKeyDown="EnterKeyDo('')" size="30" maxlength="30" value="<%=systemRole.getRolemode() %>"></td>
      --></tr>
      <tr>
        <td><div align="right">有效标志：</div></td>
        <td width="80%">
        <%out.print(cu.print("SYSTEM_ROLE","VALIDFLAG",systemRole.getValidFlag()));%><!--
        <input name="ValidFlag" type="text" class="input1" id="ValidFlag" size="30" maxlength="30" onKeyDown="EnterKeyDo('F8()')" value="<%=systemRole.getValidFlag() %>">
      --></tr>
    </table></td>
