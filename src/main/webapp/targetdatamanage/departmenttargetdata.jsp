...
<table>
	...
	<div>
		...
		<input id="periodsel" name="season" class="easyui-combobox combobox-f combo-f" style="width: 80px; display: none;" data-options="data:[{value:'Q01',text:'Ò»¼¾¶È'},{value:'Q02',text:'¶þ¼¾¶È'},{value:'Q03',text:'Èý¼¾¶È'},{value:'Q04',text:'ËÄ¼¾¶È'}],valueField:'value',textField:'text',onSelect:onPeriodChanged">
...
$("#indexsel").click(function(){
	createwindow('Ñ¡ÔñÌåÏµ','objresult.htm?getArch&class=D',500,500,returnorgValue );
    });
