...
<div >
	...
	<table id="dg" class="easyui-datagrid" style="width:150px;float:left;
       	...
       	<thead >
           	<tr >
           	<th data-options="field:'archcode',width:100" hidden="true">Ö¸±ê±àÂë</th>
           	<th data-options="field:'time',width:100" hidden="true">Ö¸±ê±àÂë</th>
               <th data-options="field:'archname',width:100">Ö¸±êÃû³Æ</th>
               </tr>
             </thead>
             <tbody>
