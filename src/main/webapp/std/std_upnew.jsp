...
%>
<BODY class="mainbody" onLoad="document.all('DocCode').focus();" scroll="no">
...
<!--  <tr>-->
<!--    <td colspan="3" valign="middle" class="table_td_jb">&nbsp;&nbsp;<a id="F8" href="#" onClick="F8()">保存[F8]</a>　<a id="F3" href="#" onClick="F3()">重填[F3]</a>　<a href="#" onClick="F5()">刷新[F5]</a></td>-->
<!--  </tr>-->
  <tr>
