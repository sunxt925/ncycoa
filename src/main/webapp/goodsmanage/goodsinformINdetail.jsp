...
%>
<base target="_self">
<a id="reload" href="goodsIn_new.jsp?StoreEventNo=<%=StoreEventNo%>" style="display:none"></a>
<HEAD>
    ...
    <td colspan="3" valign="top" class="main_table_centerbg" align="center"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
      <tr> 
		...
		<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr valign="top">
		    <td valign="top"><iframe src="goodsinformINListdetail.jsp?StoreEventNo=<%=StoreEventNo %>&detail=1" name="goodsinformINList" id="goodsinformINList" width="100%" height="100%" scrolling="no" frameborder="0"></iframe></td>
		  </tr>
		</table>
		</td>
      </tr>
