...
<%
 UserInfo u=(UserInfo)request.getSession().getAttribute("UserInfo");
	...
	DataTable dt=buyItem.getBuyGoodsitemlist(page_no,per_page);
	DataTable dtcount=buyItem.getAllBuyGoodsitemlist();
			...
			<form name="form1" id="form1" method="post"
				...
				<tr>
					<td colspan="3" valign="middle" class="table_td_jb">
						...
						&nbsp;&nbsp;
						 <a href="#" onClick="application()">申报</a>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3" valign="top" class="main_table_centerbg"
						...
						<%
							if (dt != null && dt.getRowsCount() >= 0)
							{
								...
								tu.setRowCode("提交状态","@提交状态@"+",summitflag");
								
								//根据字段值设置checkbox不可用
								tu.setCheckBoxState("提交状态");
								tu.setCheckBoxState_value("1");
								tu.setRowValue("操作","<a href=\"#\" onclick=\"modify('@buyno@')\" class=\"button4\">修改</a>");
						...
						<input name="action_class" type="hidden" id="action_class"
							value="com.action.buygoods.BuyGoodsInAction">
					</td>
				</tr>
				<tr>
