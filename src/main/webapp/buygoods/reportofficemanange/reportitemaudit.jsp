...
<body>
 <form name="form1" id="form1" method="post" action="../../servlet/PageHandler">
	   ...
	   <% if(buyReportItem.getSecondAuditFlag().equals("00")){ %>
       <% if(buyReportItem.getFirstAuditFlag().equals("11")){ %>
			<tr>
			...
			<tr>
				...
				<td>
					<%
					out.print(cu.print("COM_BUYREPORTITEM","SECONDAUDIOPINIONT",buyReportItem.getSecondAudiOpiniont())); 
					%>
				</td>
			</tr>
			<tr>
				...
				<td>
					<%
					out.print(cu.print("COM_BUYREPORTITEM","SECONDAUDITFLAG",buyReportItem.getSecondAuditFlag()));
					%>
        ...
        <input name="act" type="hidden" id="act" value="auditByOffice">
        <input name="COM_BUYREPORTITEM.SECONDAUDITDATE" id="COM_BUYREPORTITEM.SECONDAUDITDATE" type="hidden" value="<%=Format.getNowtime()%>"/>
	...
	function ret(){
		...
		var flag1="<%=buyReportItem.getSecondAuditFlag()%>"
		var flag2="<%=buyReportItem.getFirstAuditFlag()%>";
		if(flag1=="00"&&flag2=="11"){
			if(sumbit_check())
	   	    {
