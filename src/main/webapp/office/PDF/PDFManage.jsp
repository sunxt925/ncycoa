...
<form name="form1" id="form1" method="post" action="../../servlet/PageHandler">
  <tr>
    ...
    <td width="94%" valign="middle" class="main_table_topbg" height="31">首页 &gt;&gt; 文档管理 &gt;&gt; PDF文档管理 </td>
    <td width="3%" align="right" class="main_table_topbg" height="31"><img src="../../images/table_rt.jpg" width="22" height="31"></td>
  </tr>
  <tr>
    <td colspan="3" valign="middle" class="table_td_jb">&nbsp;&nbsp;　<a href="#" onClick="F5()">刷新[F5]</a>  <a href="#" onClick="F6()">本地上传[F6]</a></td>
  </tr>
  <tr>
    <td colspan="3" valign="top" class="main_table_centerbg" align="center"><table width="100%" border="1" cellpadding="0" cellspacing="0" class="table_list">
      ...
      <tr onMouseOver="this.style.backgroundColor='#D0E9ED'" onMouseOut="this.style.backgroundColor=''">
        ...
        <%
        //request.getSession().setAttribute("URL",r.getString("file_url"));
        %>
			<a href="OpenPDF.jsp?f_url=<%=r.getString("file_url")%>&f_name=<%=r.getString("file_name")%>&f_id=<%=r.getString("file_id")%>"><span style=" color:Green;">在线打开</span></a>&nbsp;&nbsp;&nbsp;				
		    <a href="PDFDelete.jsp?f_url=<%=r.getString("file_url")%>&f_name=<%=r.getString("file_name")%>&f_id=<%=r.getString("file_id")%>" ><span style=" color:Green;">删除</span></a>&nbsp;&nbsp;&nbsp;
		</td> 
      </tr>
	  <%
	  	}}
