...
function F3()
{
	...
	window.open("CreateWord.jsp?sid="+rand,"_self");
}
function F4()
{
...
{
	var rand=Math.floor(Math.random()*10000);
	window.open("FileMerge.jsp?sid="+rand,"_self");
}
</script>
...
<form name="form1" id="form1" method="post" action="../../servlet/PageHandler">
  <tr>
    ...
    <td width="94%" valign="middle" class="main_table_topbg" height="31">首页 &gt;&gt; 文档管理 &gt;&gt; word文档管理 </td>
    <td width="3%" align="right" class="main_table_topbg" height="31"><img src="../../images/table_rt.jpg" width="22" height="31"></td>
  </tr>
  <tr>
    <td colspan="3" valign="middle" class="table_td_jb">&nbsp;&nbsp;<a href="#" onClick="F3()">新建文件[F3]</a>　<a href="#" onClick="F4()">删除[F4]</a>　<a href="#" onClick="F5()">刷新[F5]</a>  <a href="#" onClick="F6()">文档合并[F6]</a></td>
  </tr>
  <tr>
    <td colspan="3" valign="top" class="main_table_centerbg" align="center"><table width="100%" border="1" cellpadding="0" cellspacing="0" class="table_list">
      ...
      <tr onMouseOver="this.style.backgroundColor='#D0E9ED'" onMouseOut="this.style.backgroundColor=''">
        ...
        <td style="text-align:center;">
			<a href="WordOpen.jsp?f_url=<%=r.getString("file_url")%>&f_name=<%=r.getString("file_name")%>&f_id=<%=r.getString("file_id")%>"><span style=" color:Green;">编辑</span></a>&nbsp;&nbsp;&nbsp;
			<a href="TaoHong.jsp?f_url=<%=r.getString("file_url")%>&f_name=<%=r.getString("file_name")%>&f_id=<%=r.getString("file_id")%>" ><span style=" color:Green;">套红</span></a>&nbsp;&nbsp;&nbsp;
			<a href="WordDelete.jsp?f_url=<%=r.getString("file_url")%>&f_name=<%=r.getString("file_name")%>&f_id=<%=r.getString("file_id")%>" ><span style=" color:Green;">删除</span></a>&nbsp;&nbsp;&nbsp;				
		</td> 
      </tr>
	  <%
	  	}}
