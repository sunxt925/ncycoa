...
<%
    ...
    String url=(String)request.getSession().getAttribute("url");  //ftp服务器下目录
	String filename =(String)request.getSession().getAttribute("pdf_name");//pdf文件名称
	String fileid =(String)request.getSession().getAttribute("pdf_id");
