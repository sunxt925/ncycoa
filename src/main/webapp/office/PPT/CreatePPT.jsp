...
//******************************卓正PageOffice组件的使用*******************************
	...
	if(tem!=null&&tem.length()>0){
		...
		poCtrl1.webOpen("Templatestream.jsp", OpenModeType.pptNormalEdit, "张三");	
	}else{
		...
		<script type="text/javascript">
		        ...
		        function lostFocus() {
		         ...
		         function OpenTemplate(){
		        	...
		        	window.open("CreatePPT.jsp?mb=" + mb,"_self");
				  ...
				  <div>
						<div align="center">
						  ...
						  <%
								...
								String sql="select template_name from office_template where template_type=2 order by template_id";
