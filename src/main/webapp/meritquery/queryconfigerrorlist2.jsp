...
<%@page import="com.entity.index.StaffIndexRelation"%>
...
<%
   ...
   List<StaffIndexRelation> res=MeritQueryHelper.queryMutilIndexRelation();
%>
<body>
   <div style="width: 100%">
    ...
    <th data-options="field:'indexcode',width:25">指标体系</th>
    </tr>
    </thead>
    <tbody>
	<%for(StaffIndexRelation s:res){ 
	%>							
			<tr>
			    <td><%=s.getStaffcode() %></td>
			    <td><%=s.getStaffname() %></td>
			    <td><%=s.getOrgname() %></td>
			    <td><%=s.getIndexcode() %></td>
			  <tr>
			  <%} %>
    </tbody>
    </table>
