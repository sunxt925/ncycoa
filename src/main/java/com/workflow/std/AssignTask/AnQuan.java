...
public class AnQuan implements AssignmentHandler{  
  
    private static final long serialVersionUID = 1L;  
    List<String> AnQuanGroup;  
    ...
    public void assign(Assignable assignable, OpenExecution execution) throws Exception {   
        ...
        AnQuanGroup=(List<String>)taskService.getVariable(task.getId(), "AnQuanGroup");  
        if(AnQuanGroup!=null){  
            for(String participant:AnQuanGroup){  
