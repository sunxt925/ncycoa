...
public class ZhuanMai implements AssignmentHandler{  
  
    private static final long serialVersionUID = 1L;  
    List<String> ZhuanMaiGroup;  
    ...
    public void assign(Assignable assignable, OpenExecution execution) throws Exception {  
        ...
        ZhuanMaiGroup=(List<String>)taskService.getVariable(task.getId(), "ZhuanMaiGroup");  
        if(ZhuanMaiGroup!=null){  
            for(String participant:ZhuanMaiGroup){  
