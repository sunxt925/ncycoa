...
public class BuyReportEventAction extends ActionInterface{
		...
		else if(action != null && action.equals("del"))
		{
			...
			String[] itemsStrings=request.getParameterValues("items");
				...
				for(int i=0;i<itemsStrings.length;i++)
				{
					...
					deletemap.put("EVENTNO", itemsStrings[i]);
				...
				res += "window.open('../buygoods/buyappeventquery.jsp?sid='+rand,'_self');";
